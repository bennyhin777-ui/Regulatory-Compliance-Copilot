...
import { ShieldCheck, Mail, Lock, ArrowRight, CircleAlert as AlertCircle } from 'lucide-react'
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-700 via-primary-800 to-primary-950 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <h2 className="text-3xl font-bold leading-tight mb-4">
            Streamline your compliance management
          </h2>
          <p className="text-primary-200 text-lg leading-relaxed mb-10">
            Track frameworks, manage tasks, assess risks, and maintain audit trails — all in one place.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-gray-50">
        <div className="w-full max-w-md">
          ...
          <div className="animate-slide-up">
            ...
            <p className="text-gray-500 mb-8">Sign in to your compliance dashboard</p>
